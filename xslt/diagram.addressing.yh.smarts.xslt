...
<!--  23 September 2021 Use new attribute x_outer_upper_bound because labels do not have hb attribute -->
<!--  would like to split the  existing rule into as many as four rules -->
<!--  start by splitting into two rules and then testing -->

<!-- new rule split off for top-->
 <xsl:template match="y/at[not(offset)]
                           [predecessor]
						   [top]	
                           [../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/padding]
                           [../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/ht]						   
                    " 
              mode="recursive_diagram_enrichment"
              priority="182"
              >
    <xsl:copy>
      <xsl:apply-templates mode="recursive_diagram_enrichment"/>
      <offset>
            <xsl:value-of select="if (outer) then -../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/(ht + padding) else 0"/>
      </offset>      
     </xsl:copy>
  </xsl:template>
 ...
 <xsl:template match="y/at[not(offset)]
                           ...
                           [*/effective_ratio]
                           [../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/padding]
                           [../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/h ]
                           [../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/hb]
                    " 
              mode="recursive_diagram_enrichment"
              priority="182"
              >
      ...
      <offset trace="8B">
                  <xsl:variable name="effective_width"
                                select = "../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/h 
								            + ../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/(hb + padding)
                                           "/>
