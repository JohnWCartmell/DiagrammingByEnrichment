...
<!-- ********************************* -->
<!-- enclosure  +x_outer_upper_offset -->
<!-- ********************************* -->
<xsl:template match="enclosure
                     [not(x_outer_upper_offset)]
					 [w]
					 [wr]
					 [padding]
   ...
   <xsl:copy>
      ...
      <x_outer_upper_offset>
	     <xsl:value-of select="w + wr + padding"/>
      </x_outer_upper_offset>
   </xsl:copy>
</xsl:template>

<!-- *********************************** -->
<!-- point|label  +x_outer_upper_offset -->
<!-- *********************************** -->
<xsl:template match="*[self::point|self::label]
   ...
   <xsl:copy>
      <xsl:apply-templates mode="recursive_diagram_enrichment"/>
      <x_outer_upper_offset>
	     <xsl:value-of select="w + padding"/>
      </x_outer_upper_offset>
   </xsl:copy>
</xsl:template>

<!-- *************************************** -->
<!-- path|cardinal|  +x_outer_upper_offset  -->
<!-- *************************************** -->
<!-- TO BE DEFINED!!!!!!!!!!!!!!!!!!!!!!!!!  -->
