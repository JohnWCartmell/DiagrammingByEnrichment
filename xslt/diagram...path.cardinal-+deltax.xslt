...
<xsl:transform version="2.0" 
 ...
 <!-- ************************* -->
<!--ew[source_sweep] + deltax  -->               <!-- NEED TP FULLY PARAMETERISE FOR NS CARDINAL -->
<!-- ************************** -->

<xsl:template match="route[top_down]/path/ew[source_sweep]
                      [not(deltax)]
                      [../../source/thisEndy]
                      [../../source/otherEndy]
                      [../../source/thisEndx]
...
<!-- ******************************** -->
<!--ew[destination_sweep] + deltax   -->               <!-- NEED TO FULLY PARAMETERISE FOR NS CARDINAL -->
<!-- ******************************** -->

<xsl:template match="route[top_down]/path/ew[destination_sweep]
                      [not(deltax)]
