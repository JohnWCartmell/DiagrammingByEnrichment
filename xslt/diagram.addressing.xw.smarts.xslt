...
<!--  23 September 2021 Use new attribute x_outer_upper_bound because labels do not have wr attribute -->
<!--  would like to split the  existing rule into as many as four rules -->
<!--  start by splitting into two rules and then testing -->

<!-- new rule split off for left-->
 <xsl:template match="x/at[not(offset)]
                           [predecessor]
						   [left]	
                           [../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/padding]
                           [../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/wl]						   
                    " 
              mode="recursive_diagram_enrichment"
              priority="172"
              >
    <xsl:copy>
      <xsl:apply-templates mode="recursive_diagram_enrichment"/>
      <offset>
            <xsl:value-of select="if (outer) then -../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/(wl + padding) else 0"/>
      </offset>      
     </xsl:copy>
  </xsl:template>
 ...
 <xsl:template match="x/at[not(offset)]
                           ...
                           [*/effective_ratio]
                           [../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/padding]
                           [../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/w ]
                           [../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/wr]
                    " 
              mode="recursive_diagram_enrichment"
              priority="172"
              >
      ...
      <offset trace="8B">
                  <xsl:variable name="effective_width"
                                select = "../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/w 
								            + ../../preceding-sibling::*[self::enclosure|self::label|self::point][1]/(wr + padding)
                                           "/>
